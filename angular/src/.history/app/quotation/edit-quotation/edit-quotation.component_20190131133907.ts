...
import { Quotation, EditQuotation } from './../../../models/quotation.model';
...
//   delWorkItem(quotation: Quotation): void {
//     abp.message.confirm(
//         'Delete Item of \'' + quotation.projectId.name + '\'?',
//         (result: boolean) => {
//             if (result) {
//                 this.quotationservice.delQuotation()
//                     .subscribe(() => {
//                         this.quoctationById = this.quoctationById.filter(u => u.id !== quotation.id);
