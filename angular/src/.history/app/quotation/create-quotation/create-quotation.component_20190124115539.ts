...
export class CreateQuotationComponent implements OnInit {
  ...
  get listworkItem(): FormArray {
    return this.taskname.get('listworkItem') as FormArray;
  }
  ...
  addFieldValue() {
    const fieldArray = this.createForm.controls.listworkItem as FormArray;
    fieldArray.push(this.newAttribute)
