...
export class CreateQuotationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.createForm = this.formBuilder.group({
      ...
      listworkItem = new this.formBuilder.group([
        taskname = new FormControl(''),   // get data from input
...
//     const control = <FormArray>this.createForm.addControl['taskname'];
//     control.push(this.initWorkItem());
//     const control2 = <FormArray>this.createForm.addControl['codingEffort'];
