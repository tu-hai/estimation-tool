...
export class EditCustomersComponent implements OnInit {
  ...
  editForm: FormGroup;
    ...
    show(id: number): void {
      this.custumerService.getCustomerById(id).subscribe(data => this.custumerList = data);
      this.active = true;
      this.modal.show();
      console.log('blkalalala nono cao ', this.custumerList)
      //     this.modal.show();
      ...
      //     this.modal.show();
      // });
      // console.log('blala liscocat', this.)
    }
    close(): void {
     this.active = false;
     this.modal.hide();
