...
import {  Quotation, CreateQuotation, SendMail, DetailQuotation, ExportPDF} from './../../models/quotation.model';
...
export class QuotationService {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        ...
        editQuotation(quotation: CreateQuotation): Observable<CreateQuotation> {
