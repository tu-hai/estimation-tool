...
import { Customer, CustomerbyPage} from './../../models/customer.model';
...
export class HomePage {
    ...
    getTotalElement(): Observable<any> {
        let url_ = this.baseUrl + '/api/getcount';
        url_ = url_.replace(/[?&]$/, '');
...
export class QuotationService {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        ...
        getQuotation(): Observable<Quotation[]> {
            ...
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<Quotation[]>(url_, httpOptions);
        } 
        getQuoctationById(id: number): Observable<any> {
            let url_ = this.baseUrl + '/api/quotationsDTO';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<any>(url_ +'/'+ id, httpOptions);
        }

        getQuotationPage(i: number): Observable<any> {
            let url_ = this.baseUrl + '/api/quotationpage';
            return this.http.get<any>(url_ +'?page='+ i, httpOptions)
        }
        ...
        getWorkItembyProject(id: number): Observable<any> {
            let url_ = this.baseUrl + '/api/WorkItemByProject';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<any>(url_ +'/'+ id, httpOptions);
        }
        ...
        delQuotation(id: number): Observable<any> {
            let url_ = this.baseUrl + '/api/quotations';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.delete<any>(url_ +'/' + id);
        }

        delWorkItem(id: number): Observable<any> {
            let url_ = this.baseUrl + '/api/work-items';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.delete<any>(url_ +'/' + id);
        }
        ...
        getListPDF(id: number): Observable<any> {
            let url_ = this.baseUrl + '/api/exportpdf';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<any>(url_ +'/'+ id, httpOptions);
        }

        // downloadPDF(id: string): string {
        // let url_ = this.baseUrl + '/api/downloadpdf';
        // url_ = url_.replace(/[?&]$/, '');
        // return `${url_}/${id}`;
           // }
        getDownloadPdfLink(id: string): string {
            let url_ = this.baseUrl + '/api/downloadpdf';
            url_ = url_.replace(/[?&]$/, '');
            return `${url_}/${id}`;
        }
...
export class CustomerService {
    ...
    getCustumerbyPage(i: number): Observable<CustomerbyPage> {
        let url_ = this.baseUrl + '/api/customerpage';
        return this.http.get<CustomerbyPage>(url_ +'?page='+ i +'&size=10', httpOptions)
    }

    deleteCustumer(id: number): Observable<Customer> {
        let url_ = this.baseUrl + '/api/delCustomer';
        url_ = url_.replace(/[?&]$/, '');
...
export class ProjectService {
    ...
    getProjectsbyPage(i: number): Observable<Project> {
        let url_ = this.baseUrl + '/api/projectpage';
        return this.http.get<Project>(url_ +'?page='+ i, httpOptions)
    }
