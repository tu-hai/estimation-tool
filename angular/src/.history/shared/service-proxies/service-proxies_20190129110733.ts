...
import { Project, EditProject } from '../../models/project';
import * as moment from 'moment';
import { Customer} from './../../models/customer.model';
import {  Quotation, CreateQuotation, SendMail, DetailQuotation} from './../../models/quotation.model';
...
export class QuotationService {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        ...
        getQuoctationById(id: number): Observable<DetailQuotation> {
            let url_ = this.baseUrl + '/api/quotationsDTO';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<DetailQuotation>(url_ +'/'+ id, httpOptions).pipe();
        }
        ...
        exportPDF() {
            let url_ = this.baseUrl + '/api/pdf';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<CreateQuotation>(url_,);
        }
...
export class ProjectService {
    ...
    getProjectById(id: number): Observable<EditProject> {
        let url_ = this.baseUrl + '/api/projectsDTO';
        url_ = url_.replace(/[?&]$/, '');
        return this.http.get<EditProject>(url_ +'/'+ id, httpOptions)
    }
