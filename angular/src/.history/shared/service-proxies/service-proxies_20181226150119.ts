...
// get all projects for quotation screen
export class getAllprojectsList{
    id: number;
    name: string;
    dateStrart: string;
}
...
export class getAllProjects {
    ...
    getAllProjects(): Observable<getAllprojectsList> {
          let url_ = this.baseUrl + "/api/projectss";
        return this.http.get<getAllprojectsList[]>(url_).pipe();
    }
}
...
export class TokenAuthServiceProxy {
    ...
    authenticate(model: AuthenticateModel | null | undefined): Observable<AuthenticateResultModel> {
        ...
        console.log("post option", url_, options_);
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
