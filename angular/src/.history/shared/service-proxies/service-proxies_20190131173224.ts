...
export class QuotationService {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        ...
        getQuoctationById(id: number): Observable<EditQuotation> {
            let url_ = this.baseUrl + '/api/quotationsDTO';
            url_ = url_.replace(/[?&]$/, '');
            return this.http.get<EditQuotation>(url_ +'/'+ id, httpOptions).pipe();
        }
        ...
        getListPDF(id: number): Observable<any> {
            let url_ = this.baseUrl + '/api/getpdfbyquotation';
            url_ = url_.replace(/[?&]$/, '');
        ...
        downloadPDF(id: number): Observable<any> {
            ...
            url_ = url_.replace(/[?&]$/, '');
            return this.http.post<any>(url_ +'/'+ id, httpOptions).pipe();
        }
