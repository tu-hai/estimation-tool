...
public class ProjectResourceIntTest {
    ...
    private static final LocalDate DEFAULT_DATE_STRART = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_STRART = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project()
            .name(DEFAULT_NAME)
            .dateStrart(DEFAULT_DATE_STRART)
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getDateStrart()).isEqualTo(DEFAULT_DATE_STRART);
        assertThat(testProject.getDateEnd()).isEqualTo(DEFAULT_DATE_END);
    }
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateStrart").value(hasItem(DEFAULT_DATE_STRART.toString())))
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.dateStrart").value(DEFAULT_DATE_STRART.toString()))
    ...
    public void updateProject() throws Exception {
        ...
        updatedProject
            .name(UPDATED_NAME)
            .dateStrart(UPDATED_DATE_STRART)
        ...
        assertThat(testProject.getDateStrart()).isEqualTo(UPDATED_DATE_STRART);
        assertThat(testProject.getDateEnd()).isEqualTo(UPDATED_DATE_END);
    }
